      ...
      <section id="contact" className=" bg-contact-bg  py-20 bg-bg">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 ">
            ...
            <p className="text-gray-600 text-lg" data-i18n="contactSubtitle">
              ...
              <div className="bg-primary p-10">
                <form className="space-y-5">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gold focus:border-transparent outline-none transition"
                    />
                  </div>
                  <div>
                    <label
