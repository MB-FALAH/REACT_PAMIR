...
function ReviewModal({ isOpen, onClose, onReviewSubmit }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
      <div className="bg-[#222222] rounded-2xl max-w-2xl w-full border border-gold/30">
        ...
        >
          {error && (
            <div className="bg-red-900/50 text-red-300 p-3 rounded">
              {error}
            </div>
          )}
          ...
          <input
            ...
            value={name}
            onChange={(e) => setName(e.target.value)}
            className="w-full p-3 rounded bg-black text-white border border-gold/30"
          />
          ...
          <div className="flex gap-4">
            <button
              ...
              className="flex-1 bg-yellow-500 text-black font-bold py-3 rounded"
            >
              {isSubmitting
                ? "Submitting..."
                : "Submit Review"}
            ...
            <button
              type="button"
              onClick={handleClose}
              className="px-6 bg-gray-700 text-white rounded"
            >
              Close
            </button>
          </div>
